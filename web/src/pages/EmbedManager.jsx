      ...
      <div className="bg-discord-bg-light p-6 rounded-lg">
        ...
        {configLoading ? (
          ...
          <form onSubmit={handleConfigSave} className="space-y-4">
            {/* Restricted Content Warning Settings - Only for Instagram */}
            {activeTab === 'instagram' && (
              <div className="border-b border-gray-700 pb-4 mb-4">
                ...
                <div className="flex items-center space-x-3 mb-4">
                  <input
                    ...
                    onChange={e => handleInstagramConfigChange('silence_restricted_warning', e.target.checked)}
                ...
                <div className="mb-2">
                  ...
                  <textarea
                    ...
                    onChange={e => handleInstagramConfigChange('restricted_warning_message', e.target.value)}
